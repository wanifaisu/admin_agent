        ...
        <Form className="w-full" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col rounded-full justify-center mt-[0.625rem] mb-[1.25rem] 2xl:mb-[3.125rem] 2xl:mt-[4.063rem]">
            <button
              ...
              className={`w-full z-10 text-black bg-[#ffb200] hover:bg-yellow-500 rounded-2xl 2xl:px-[5.813rem] 2xl:py-[0.46rem] 2xl:text-2xl text-xl px-1 py-2  font-extrabold mt-10 inline-block transition duration-300 ${
