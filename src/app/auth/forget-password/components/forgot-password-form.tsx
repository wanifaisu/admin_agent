      ...
      {({ isSubmitting }) => (
        <Form>
          ...
          <button
            ...
            className="w-full z-10 text-black bg-[#ffb200] hover:bg-yellow-500 rounded-2xl 2xl:px-[5.813rem] 2xl:py-[0.46rem] 2xl:text-2xl text-xl px-10 py-2  font-extrabold mt-10 inline-block transition duration-300"
          >
